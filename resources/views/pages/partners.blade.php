    ...
    <div class="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="grid gap-14 lg:grid-cols-[1fr_1.1fr] items-center">
            ...
            <div class="animate-fade-up">
                ...
                <h1 class="mt-5 text-[2.2rem] font-bold leading-tight sm:text-[2.6rem]"
                    style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">
                    Seller Lokal Mendapat<br>
                    <em class="not-italic" style="color:var(--gold-500);">Etalase Digital</em><br>
                    Berbasis Budaya.
                </h1>
                <p class="font-body text-base leading-relaxed" style="color:var(--kriya-600);">
                ...
                <div class="mt-10 flex flex-wrap gap-6">
                    <div class="stat-box text-center min-w-[90px]">
                        <p class="text-xl font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-500);">2 Tipe</p>
                        <p class="text-xs font-semibold mt-1" style="color:var(--kriya-600);">Penjualan</p>
                    </div>
                    <div class="stat-box text-center min-w-[90px]">
                        <p class="text-xl font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-500);">UMKM</p>
                        <p class="text-xs font-semibold mt-1" style="color:var(--kriya-600);">Fokus Budaya</p>
                    </div>
                    <div class="stat-box text-center min-w-[90px]">
                        <p class="text-xl font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-500);">Free</p>
            ...
            <div class="animate-fade-up delay-200 grid grid-cols-2 gap-4">
                ...
                <div class="card-kriya p-6 flex flex-col gap-3">
                    ...
                    <h3 class="text-sm font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">Etalase Produk</h3>
                ...
                <div class="card-kriya p-6 flex flex-col gap-3">
                    ...
                    <h3 class="text-sm font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">Pesanan Masuk</h3>
                ...
                <div class="card-kriya p-6 flex flex-col gap-3">
                    ...
                    <h3 class="text-sm font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">Laporan Penjualan</h3>
                ...
                <div class="card-kriya p-6 flex flex-col gap-3">
                    ...
                    <h3 class="text-sm font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">Semi E-commerce</h3>
...
{{-- ============================================================
     ...
     ============================================================ --}}
<section class="section-panel--warm relative py-16">
    ...
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="mt-3 text-2xl font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">
        ...
        <div class="grid gap-6 md:grid-cols-3">
            ...
            <div class="card-kriya p-7 flex flex-col items-start gap-3">
                <span class="text-3xl font-bold opacity-20" style="font-family:'Cinzel',Georgia,serif; color:{{ $step['color'] }};">{{ $step['num'] }}</span>
                <h3 class="text-sm font-bold" style="font-family:'Cinzel',Georgia,serif; letter-spacing:0.04em; color:var(--kriya-800);">{{ $step['title'] }}</h3>
                <div class="w-8 h-px" style="background:linear-gradient(90deg, var(--gold-400), transparent); opacity:0.6;"></div>
                <p class="font-body text-sm leading-6" style="color:var(--kriya-600);">{{ $step['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
