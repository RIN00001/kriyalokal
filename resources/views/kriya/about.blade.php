...
@section('content')
    ...
    <section class="relative overflow-hidden kriya-pattern py-20 md:py-28">
        ...
        <div class="relative mx-auto max-w-3xl px-4 text-center md:px-6">
            ...
            <h1 class="mt-6 font-serif-display text-4xl md:text-5xl font-bold text-kriya-cream-light">
            ...
            <p class="mt-6 text-kriya-cream/85 font-body-serif leading-relaxed text-lg">
